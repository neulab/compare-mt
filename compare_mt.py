...
def print_src_analysis_report(src, ref, out1, out2, ref_align, out1_align, out2_align,
                          acc_type='fmeas', bucket_type='freq',
                          freq_count_file=None, freq_corpus_file=None,
                          label_set=None,
                          src_labels=None):
...
if __name__ == '__main__':
  ...
  parser.add_argument('--src_analysis', type=str, nargs='*',
                      ...
                      See documentation for 'print_src_analysis_report' to see which arguments are available.
                      """)
  ...
  if args.src_analysis:
    print_header('Source Word Analysis')
    assert(src), "Must specify the source file!"
    for profile in args.src_analysis:
      kargs = parse_profile(profile)
      print_src_analysis_report(src, ref, out1, out2, **kargs)
      print()
