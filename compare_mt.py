...
def print_word_accuracy_report(ref, out1, out2,
  ...
  if case_insensitive:
    print('--------- case sensitive results ----------')
    print_word_accuracy_report(src, ref, out1, out2, acc_type, bucket_type, freq_count_file, freq_corpus_file, label_set, ref_labels, out1_labels, out2_labels, case_insensitive=False)
    print('--------- case insensitive results ----------')
